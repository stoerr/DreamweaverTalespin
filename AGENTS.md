...
- Quick checklist for first edits / investigation:
  ...
  2. Inspect `docs/app.js` for the exact logic you want to change (look for functions named `callOpenAI`, `generateChapter`, `populateVoicesAndLanguages`, `speakChapter`).
