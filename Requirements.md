...
- The last story prompt should be stored in local storage and restored on reload - key 'net.stoerr.aiexperiments.DreamweaverTalespin.storyprompt'. Similarily, store the last voice selection.
